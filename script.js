...
//события смены фокуса и др.
// formModal.count.addEventListener('focus', e => {
//   console.warn(e.type, e.target.value);
// });
  
// formModal.count.addEventListener('blur', e => {
//   console.error(e.type, e.target.value);
// });
  

// formModal.count.addEventListener('change', e => {
//   console.log(e.type, e.target.value);
// });
  
//Деструктуризация формы 
// const { count, file, price } = formModal;

// console.log(count, price, file);
